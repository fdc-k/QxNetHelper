...
const ALLOWED_QUERY_KEYS = ['encryption', 'flow', 'security', 'sni', 'fp', 'pbk', 'type', 'headerType'] as const;
...
const parseAuthority = (authority: string): { readonly uuid: string; readonly server: string; readonly port: number } => {
...
export const parseVlessUri = (nodeUrl: string): ParsedVlessShareLink => {
...
export const normalizeVlessUri = (nodeUrl: string, options: NormalizeProxyOptions): VlessProxy => {
